import os
import fitz  # install PyMuPDF to get fitz
import uuid
...
class DocumentHandler:
    ...
    def __init__(self, data_dir=None, session_id=None):
        try:
            ...
            self.log.info("PDFHandler initialized.",
                          session_id=self.session_id, session_path=self.session_path)
        except Exception as e:
            self.log.error("Error initialising DocumentHandler: {e}")
            raise DocumentPortalException(
                "Error initializing DocumentHandler", e) from e
        ...
        try:
            ...
            with fitz.open(pdf_path) as doc:
                ...
                self.log.info("PDF read successfully.",
                              pdf_path=pdf_path, session_id=self.session_id)
                return text
        except Exception as e:
